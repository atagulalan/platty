...
function collapsedUsersLine(summary: ReturnType<typeof readySummary>): React.JSX.Element {
  return (
...
export function UserListPanel({
  ...
  const { start, end } = scrollWindow(rows.length, visibleLines, cursorRow === -1 ? 0 : cursorRow);
